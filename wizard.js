...
async function main() {
  ...
  console.log(`
This wizard will:
  ${c.dim('1.')} ask which channels to forward (you pick everything — no defaults)
  ${c.dim('2.')} install dependencies
...
`);
  ...
  // 1. channel selection — the very first thing, nothing pre-selected
